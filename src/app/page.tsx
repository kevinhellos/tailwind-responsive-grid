...
export default function page() {
  return (
    <div>
      ...
      <span className="ms-5 text-xs">Class:</span>
      <p className="ms-5 px-5 mb-10 w-fit bg-gray-100">grid grid-cols-4</p>
      ...
      <span className="ms-5 text-xs">Class:</span>
      <p className="ms-5 px-5 mb-10 w-fit bg-gray-100">grid <span className="text-blue-500">md</span>:grid-cols-2 <span className="text-red-500">lg</span>:grid-cols-4</p>
      ...
      <span className="ms-5 text-xs">Class:</span>
      <p className="ms-5 px-5 mb-10 w-fit bg-gray-100">grid <span className="text-blue-500">md</span>:grid-cols-3 <span className="text-red-500">lg</span>:grid-cols-6</p>
